        ...
        <div className="space-y-6">
          <div className="bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 border-b border-slate-100 bg-slate-50/50">
              <div>
                <h3 className="text-base font-bold text-slate-800">Monitoring Pengisian Data Guru</h3>
                <p className="text-xs text-slate-500 mt-1">
                  Monitoring jumlah pengisian Tujuan Pembelajaran (TP), Lingkup Materi (LM), dan persentase pengisian nilai siswa per guru secara real-time.
                </p>
              </div>
            </div>
